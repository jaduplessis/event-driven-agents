...
import { getEnvVariable, getParameter, getRegion } from "@event-driven-agents/helpers";
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <p>Thank you for installing our Snacks. We're excited to have you on board!</p>
        </div>
      </body>
    </html>
  `;

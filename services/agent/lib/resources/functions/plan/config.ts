...
export class Plan extends Construct {
  ...
  constructor(
    ...
    this.function = new SlackCustomResource(this, buildResourceName("plan"), {
    ...
    new Rule(this, buildResourceName("on-plan-requested-event"), {
      eventBus,
      eventPattern: {
        source: ["application.slackIntegration"],
        detailType: ["agent.plan"],
      },
